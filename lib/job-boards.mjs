...
export function buildJobSearchUrls(options = {}) {
  ...
  const boardIds = options.boardIds && options.boardIds.length ? new Set(options.boardIds) : null;
  // An explicitly empty list means "nowhere" — the UI clears every chip and
