...
export function opportunityContentKey(job?: { company?: string; title?: string; location?: string; sourceUrl?: string }): string;
export function hasAuthoritativeJobId(value: unknown): boolean;
