...
body { margin: 0; padding: 0; background: #fff; color: #111; font-family: Georgia, 'Times New Roman', serif; font-size: 10.5pt; line-height: 1.46; }
...
.resume-contact { margin: 6pt 0 0; font-size: 9pt; color: #444; }
.resume-rule { border: 0; border-top: 1.5pt solid #111; margin: 9pt 0 0; }
h2 { margin: 17pt 0 8pt; padding-bottom: 2pt; border-bottom: 0.75pt solid #999; font-size: 10pt; font-weight: 700; letter-spacing: 0.09em; text-transform: uppercase; }
p { margin: 0 0 7pt; }
ul { margin: 5pt 0 0; padding-left: 15pt; }
li { margin: 0 0 4.5pt; }
.entry { margin: 0 0 13pt; page-break-inside: avoid; }
.entry-line { margin: 0 0 1.5pt; overflow: hidden; }
...
.plain-list li { margin: 0 0 4.5pt; }
`.trim();
