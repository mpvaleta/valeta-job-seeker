...
const TRUSTED_JOB_SOURCES = new Set(["apple", "ashby", "google-careers", "greenhouse", "imported", "lever", "linkedin-saved", "meta-job", "public-job-page", "smartrecruiters", "structured-job-page", "v-watch", "workday"]);
