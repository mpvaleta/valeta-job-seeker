...
export default function AppError({ error, reset }: FatalErrorProps) {
  ...
  function createReport() {
    ...
    return JSON.stringify({ product: "V's Job Seeker", build: "2026.07-voice-autofill-r9", generatedAt: new Date().toISOString(), privacy: "No résumé text, approved facts, raw documents, profile fields, credentials, or API keys are included.", errors }, null, 2);
  }
