      ...
      <section className="main-stage">
        ...
        {view === "ai" && <section className="ai-reliability">
          <div className="ai-status-card">
            ...
            {!aiConnection.configured && <div className="setup-note"><strong>What is still needed</strong><p>Open ChatGPT Sites, find <em>Valeta&apos;s Job Seeker</em>, choose <b>More actions → Settings</b>, and add <code>OPENAI_API_KEY</code> as a secret. Then ask for this saved version to be redeployed. The key must never be pasted into chat or this app, committed to GitHub, or stored in browser data. <code>OPENAI_MODEL</code> is optional; the default is <code>gpt-5.6-sol</code>.</p><a href="https://chatgpt.com/sites" target="_blank" rel="noreferrer">Open ChatGPT Sites ↗</a></div>}
