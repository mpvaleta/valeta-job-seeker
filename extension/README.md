# Valeta Application Autofill companion

This unpacked Chrome extension previews and fills common job-application fields from the JSON package exported by Valeta Job Seeker. It detects common Greenhouse, Lever, Workday, Ashby, iCIMS, and SmartRecruiters pages, but uses the visible form fields rather than scraping the platform. It never clicks submit, never fills file uploads, and highlights sensitive fields and dropdowns for manual review.
...
5. In Valeta Job Seeker, open **Autofill assistant** and download the JSON package.
